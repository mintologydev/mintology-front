...
import ProductDetails from 'components/Item/productDetailsDod'
...
const ActiveItem = props => {
  ...
  const [openBuyModal, closeBuyModal] = useModal(<BuyModal toBuy={toBuy} price={price}></BuyModal>)
    ...
    <div className="item-container">
      ...
      <div className="product-detail-box">
        <h3 className="title">
          ...
          <a
            href="https://docs.google.com/forms/d/e/1FAIpQLSegedaz8gALdSjmCZs0nqf_GFQqiE-O7becslq-RA6-VT-1jw/viewform/forms/d/1TVJVUVjKz5O2wpYnpBhOiPczk3zVRQ4NGXuGDk4gSlI/edit"
            target="_blank">
